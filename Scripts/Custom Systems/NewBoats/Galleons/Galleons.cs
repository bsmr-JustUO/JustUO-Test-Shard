...
namespace Server.Multis
{
    public class TokunoGalleon : BaseGalleon
    {
		...
		private BoatRope m_PRope, m_SRope;
            ...
            : base(0x30)
        {
			...
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, -2, 6), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, -2, 6), BoatRopeSide.Port, 0 ); 
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, 3, 6), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, 3, 6), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
    ...
    public class GargoyleGalleon : BaseGalleon
    {
            ...
            : base(0x24)
        {
			...
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, -4, 14), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, -4, 14), BoatRopeSide.Port, 0 ); 
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, -1, 14), BoatRopeSide.Starboard, 0 );
			Ropes.Add(m_SRope);			
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, -1, 14), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, 2, 14), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, 2, 14), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
    ...
    public class OrcGalleon : BaseGalleon
    {
            ...
            : base(0x18)
        {
			...
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, -1, 14), BoatRopeSide.Port, 0 ); 
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, 3, 14), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, 3, 14), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-2, 7, 14), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(2, 7, 14), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
    ...
    public class BritainGalleon : BaseGalleon
    {
            ...
            : base(0x40)
        {
			...
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-3, -4, 16), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(3, -4, 16), BoatRopeSide.Port, 0 ); 
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-3, 0, 16), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(3, 0, 16), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-3, 4, 16), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(3, 4, 16), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
			m_SRope = new BoatRope(this, 0x14F8, new Point3D(-3, 8, 16), BoatRopeSide.Starboard, 0 ); 
			Ropes.Add(m_SRope);
			m_PRope = new BoatRope(this, 0x14F8, new Point3D(3, 8, 16), BoatRopeSide.Port, 0 );
			Ropes.Add(m_PRope);
